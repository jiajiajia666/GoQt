...
import (
	...
	_ "github.com/jiajiajia666/GoQt/internal/examples/sql/masterdetail_qml/view"
)
...
func main() {
	...
	if PRODUCTION {
		...
		path = filepath.Join(os.Getenv("GOPATH"), "src", "github.com", "jiajiajia666", "qt", "internal", "examples", "sql", "masterdetail_qml", "view", "qml", "view.qml")
	}
