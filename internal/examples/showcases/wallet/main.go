...
import (
	...
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/assets"

	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/dashboard"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/files"
	fcontroller "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/files/controller"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/hosting"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/terminal"
	tcontroller "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/terminal/controller"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/theme"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/view"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/view/left"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/view/top"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/wallet"
	wcontroller "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/wallet/controller"
	_ "github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/wallet/dialog"

	"github.com/jiajiajia666/GoQt/internal/examples/showcases/wallet/controller"
)

var (
	pathToProject      = filepath.Join(os.Getenv("GOPATH"), "src", "github.com", "jiajiajia666", "qt", "internal", "examples", "showcases", "wallet")
