...
import (
	...
	"github.com/jiajiajia666/GoQt/internal/binding/templater"

	"github.com/jiajiajia666/GoQt/internal/cmd"
	"github.com/jiajiajia666/GoQt/internal/cmd/deploy"
	"github.com/jiajiajia666/GoQt/internal/cmd/minimal"
	"github.com/jiajiajia666/GoQt/internal/cmd/moc"
	"github.com/jiajiajia666/GoQt/internal/cmd/rcc"
...
func Test(target string, docker, vagrant bool, vagrantsystem string) {
	...
	for cat, list := range examples {
		for _, example := range list {
			...
			path := filepath.Join(strings.TrimSpace(utils.GoListOptional("{{.Dir}}", "github.com/jiajiajia666/GoQt/internal/examples", "-find", "get doc dir")), example)
