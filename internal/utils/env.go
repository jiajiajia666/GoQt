...
func GoList(args ...string) *exec.Cmd {
	...
	if UseGOMOD("") {
		if !(strings.Contains(strings.Join(args, "|"), "github.com/jiajiajia666/GoQt/internal") && !strings.Contains(strings.Join(args, "|"), "github.com/jiajiajia666/GoQt/internal/binding/runtime")) {
