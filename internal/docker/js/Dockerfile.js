...
RUN /usr/local/go/bin/go get -tags=no_env github.com/jiajiajia666/GoQt/cmd/...
...
COPY --from=base $GOPATH/src/github.com/jiajiajia666/GoQt $GOPATH/src/github.com/jiajiajia666/GoQt
...
RUN cd $GOPATH/src/github.com/jiajiajia666/GoQt/internal/examples/widgets/line_edits && $GOPATH/bin/qtdeploy build js && rm -rf ./deploy
